                ...
                <div class="panel-body">
                    ...
                    <table id="record" class="table table-striped table-hover table-bordered">
                        ...
                        <?php
                            ...
                            // }
                            $mysqli = mysqli_connect($databaseHost, $databaseUsername, $databasePassword, $databaseName);
                            $query = "SELECT student_data.id, student_data.fullname, grades.exam_grade, grades.interview_grade FROM student_data LEFT JOIN grades ON student_data.id = grades.student_id";
                            $result = mysqli_query($mysqli, $query);
                            while ($addrow = mysqli_fetch_array($result)) {
                                $averageGrade = ($addrow['exam_grade'] + $addrow['interview_grade']) / 2;
                                echo "<tr>";
                                echo "<td>$addrow[0]</td>";
                                echo "<td><a href='view.php?id=$addrow[0]' target='_blank'>$addrow[1]</a></td>";
                                echo "<td>$addrow[2]</td>";
