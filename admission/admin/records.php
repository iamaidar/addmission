        ...
        <div class="col-md-9">
            ...
            <div class="panel panel-default">
                ...
                if (isset($_POST['searchQuery'])){
                  ...
                  $Equery = "select student_data.id,student_data.FULLNAME,student_data.EMAIL,selected_courses.coursename,student_data.register_date, student_data.approved FROM student_data JOIN selected_courses ON student_data.ID=selected_courses.ID
                  ...
                  $query = "select student_data.id,student_data.FULLNAME,student_data.EMAIL,selected_courses.coursename,student_data.register_date, student_data.approved FROM student_data JOIN selected_courses ON student_data.ID=selected_courses.ID";
                  $result = mysqli_query($mysqli,$query);
                  while($addrow = mysqli_fetch_array($result)){
