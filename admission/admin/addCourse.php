...
<body>
   ...
   <header id="header">
      <div class="container">
         <div class="row">
            <div class="col-md-10">
               <h1><span class="glyphicon glyphicon-cog" aria-hidden="true"></span> Add Faculties </h1>
            </div>
         </div>
      </div>
      </div>
               ...
               <div class="col-md-10">
                  ...
                  <div class="form-group">
                     <label>Enter Faculty Name</label>
							        <input type="text" name='cname' placeholder="Enter Faculty Name Here.." class="form-control" required>
						      </div>
                     <input class="btn btn-info" type="submit" name="addCourse" value="Submit">
                     </form>
                     <div class="panel panel-default">
            <div class="panel-heading">
               <h3 class="panel-title">Available Faculties</h3>
            </div>
            <div class="panel-body">
