<?php
	...
	if(isset($_SESSION['email']))
	{
        ...
        $q5 ="SELECT count(*) from selected_courses";
        ...
        $res5 = $mysqli->query($q5) or die($mysqli->error);
		if($res5->num_rows > 0) 
		{
...
<div class="col-md-3">
    <div class="list-group">
        ...
        <a href="records.php" class="list-group-item"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> Applied Student Records <span class="badge"><?php echo $val5;?></span></a>
    ...
    <!-- <a href="grades.php" class="list-group-item"><span class="glyphicon glyphicon-user" aria-hidden="true"></span> Grades <span class="badge"></span><</a> -->
    <a href="grades.php" class="list-group-item"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> Grades <span class="badge"><?php echo $val4;?></span></a>
         <a href="addCourse.php" class="list-group-item"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Add Faculty <span class="badge"><?php echo $val2;?> </span></a>
