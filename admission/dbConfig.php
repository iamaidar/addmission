...
if (isset($_POST['addRegister']))
	...
	if ($password == $password2){
		...
		{	
			...
			// 	(NULL,'$fullname','$gender','$address','$city','$state','$pnumber','$email','$password',NOW(),'$dob','$image',1)";
			$sql = "INSERT INTO `student_data` VALUES 
        (NULL, '$fullname', '$gender', '$address', '$city', '$state', '$pnumber', '$email', '$password', NOW(), '$dob', '$image', 1, 'Not Applied')";
