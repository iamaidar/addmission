...
<div class="col-md-9">
  ...
  <div class="panel panel-default">
    ...
    <div class="panel-body">
      <p>1. Once registered on the portal you can apply for faculties given in the options 
      </p>
      <p>2. You'll have to submit your educational details in your profile in the 'Profile' section. 
      </p>
      <p>3. After submitting the educational details apply for faculty. 
      </p>
      <p>4. In course selection select the respective University and then the respective faculty.
      </p>
    </div>
  </div>
</div>
